...
async function loadCountries() {
  try {
    ...
    // Sicherstellen, dass die Plattformwahl abgeschlossen ist, bevor der Startbildschirm initialisiert wird
    await checkPlatformChoice();
    console.log("Platform choice handled, initializing start screen.");
